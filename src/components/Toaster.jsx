...
export default function Toaster() {
  ...
  return (
    <div
      className="pointer-events-none fixed bottom-4 right-4 left-4 z-[10000] flex w-auto flex-col items-stretch gap-3 sm:left-auto sm:w-96"
          ...
          >
            <div className="flex items-start gap-3 p-4">
              ...
              <div className="min-w-0 flex-1 pt-0.5">
                ...
                {toast.message && (
                  <p className={`text-sm ${toast.title ? 'mt-0.5' : ''} break-words text-app-text-2`}>
                    {toast.message}
                  </p>
                )}
              </div>
